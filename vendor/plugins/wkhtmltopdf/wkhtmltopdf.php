<?php
        ...
        class WKPDF {
                ...
                /**
                 * Set stylesheet, use constants from this class.
                 * By default stylesheet is screen.
                 * @param string $mode Use constants from this class.
                 */
                public function set_stylesheet($media){
                        $this->css=$media;
                }
                /**
                 * Set page/paper size.
                ...
                /**
                 * Set footer FILE.
                 * @param string $footer Footer file name and dir
                 */
                ...
                /**
                 * Set output FILE.
                 * @param string $output Output filename and dir
                 */
                ...
                /**
                 * Set margins.
                 * By default margins are 10mm.
                 * @param int $top Top paper margin
                 * @param int $right Right paper margin
                 * @param int $bottom Bottom paper margin
                 * @param int $left Left paper margin
                 */
                public function set_margins($top = 10, $right = 10, $bottom = 10, $left = 10){
                        $this->top=$top;
                        $this->right=$right;
                        $this->bottom=$bottom;
                        $this->left=$left;
                ...
                /**
                 * Set url.
                 * @param string $url Set url to pull the html from.
                 */
                ...
                public function render(){
                        ...
                        $cmd =  '"'.$this->cmd.'"'
                                ...
                                .($this->footer?' --footer-html "'.$this->footer.'"':'')                                       // footer url
                                .' --margin-top '.$this->top                                                                    // margin top
                                .' --margin-right '.$this->right                                                                    // margin right
                                .' --margin-bottom '.$this->bottom                                                                    // margin bottom
                                .' --margin-left '.$this->left                                                                    // margin left
                                .($this->toc?' --toc':'')                                                                               // table of contents
                                .($this->grayscale?' --grayscale':'')                                                   // grayscale
                                .(($this->title!='')?' --title "'.$this->title.'"':'')                  // title
                                .(($this->css=='print')?' --print-media-type':'')                  // media type
                                .' "'.$web.'"'
